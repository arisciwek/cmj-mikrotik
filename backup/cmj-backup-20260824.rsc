# 2026-08-24 08:23:46 by RouterOS 7.23.1
...
add address=192.168.18.19 comment="zimbra server" name=zimbra.lan ttl=1h \
    type=A
add address=192.168.18.18 comment=CMJ-carbonio-webmail name=\
    mail.ciptamasjaya.co.id type=A
add address=192.168.18.18 name=app.ciptamasjaya.lan type=A
...
add action=accept chain=forward dst-address=10.100.0.0/24 src-address=\
    192.168.10.0/24
add action=accept chain=input comment=CMJ-allow-mail-relay dst-port=587,465 \
    protocol=tcp src-address=192.168.18.0/24
add action=accept chain=input comment=CMJ-allow-mail-from-wg dst-port=25 \
    protocol=tcp src-address=10.100.0.0/24
add action=accept chain=input comment=CMJ-allow-smtp-from-wg dst-port=25 \
    protocol=tcp
add action=accept chain=input comment=CMJ-allow-smtp-from-wg dst-port=25 \
    protocol=tcp src-address=10.100.0.0/24
/ip firewall nat
add chain=dstnat comment=CMJ-inbound-mail-from-VPS disabled=yes dst-port=25 \
    protocol=tcp src-address=10.100.0.1 to-addresses=192.168.18.19 to-ports=\
    25
add action=dst-nat chain=dstnat comment=CMJ-smtp-relay-to-VPS disabled=yes \
    dst-port=25 protocol=tcp src-address=10.100.0.1 to-addresses=10.100.0.1 \
    to-ports=25
...
add action=dst-nat chain=dstnat comment=CMJ-nat-587-to-vps dst-port=587 \
    protocol=tcp to-addresses=10.100.0.1 to-ports=587
add action=dst-nat chain=dstnat comment=CMJ-virtualmin-inbound-mail-from-VPS \
    dst-port=25 protocol=tcp src-address=10.100.0.1 to-addresses=\
    192.168.18.18 to-ports=25
add action=src-nat chain=srcnat comment=CMJ-virtualmin-outbound-to-VPS \
    dst-address=10.100.0.1 dst-port=25 protocol=tcp src-address=192.168.18.18 \
    to-addresses=10.100.0.2
add action=dst-nat chain=dstnat comment=\
    CMJ-virtualmin-inbound-mail-from-VPS-port2525 dst-port=2525 protocol=tcp \
    src-address=10.100.0.1 to-addresses=192.168.18.18 to-ports=25
add action=dst-nat chain=dstnat comment=\
    CMJ-carbonio-inbound-mail-from-VPS-port25 disabled=yes dst-port=25 \
    protocol=tcp src-address=10.100.0.1 to-addresses=192.168.18.19 to-ports=\
    25
add action=dst-nat chain=dstnat comment=CMJ-virtualmin-inbound-to-router-IP \
    dst-address=10.100.0.2 dst-port=25 protocol=tcp to-addresses=\
    192.168.18.18 to-ports=25
/ip route
